...
mongodb_connection_string = sys.argv[1] # mongodb://myDBReader:D1fficultP%40ssw0rd@mongodb0.example.com:27017/?authSource=admin

APP_EXE_PATH = r"C:\Program Files\3T Software Labs\Studio 3T\Studio 3T.exe"  # -- Path to .exe file that you want to automate.
...
def workflow(driver: webdriver.Remote):
    ...
    driver.find_element_by_xpath('//*[@Name="New Connection"][@LocalizedControlType="button"]').click()
    pyautogui.write(mongodb_connection_string)
    driver.find_element_by_xpath('//*[@Name="Next"][@LocalizedControlType="button"]').click()
    driver.find_element_by_xpath('//*[@Name="OK"][@LocalizedControlType="button"]').click()
    driver.find_element_by_xpath('//*[@Name="Connection name:"][@LocalizedControlType="edit"]').click()
    pyautogui.write("mongodb")
    driver.find_element_by_xpath('//*[@Name="Save"][@LocalizedControlType="button"]').click()
    try:
        driver.find_element_by_xpath('//*[@Name="Remind me later"][@LocalizedControlType="button"]').click()
    except:
        pass
    try:
        driver.find_element_by_xpath('//*[@Name="Overwrite"][@LocalizedControlType="button"]').click()
    except:
        pass
    driver.find_element_by_xpath('//*[@Name="mongodb"][@LocalizedControlType="tree item"]').click()
    pyautogui.press("enter")
    # ActionChains(driver).context_click(driver.find_element_by_xpath('//*[@Name="mongodb"][@LocalizedControlType="tree item"]')).perform() 
